...
void use_classic_font() {
	use_font("MS Sans Serif", "Arial");
}
...
void use_aqua_font() {
	use_font("Lucida Grande", "Helvetica");
}
...
OS::Theme OS::global_current_theme = AQUA;
#else
