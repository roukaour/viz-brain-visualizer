...
class Modal_Dialog {
public:
	enum Icon { NO_ICON, SUCCESS_ICON, WARNING_ICON, ERROR_ICON, PROGRAM_ICON };
	static Fl_Pixmap SUCCESS_SHIELD_ICON, WARNING_SHIELD_ICON, ERROR_SHIELD_ICON, VIZ_ICON;
private:
	Icon _icon_type;
...
public:
	Modal_Dialog(Fl_Window *top, const char *t = NULL, Icon c = NO_ICON);
	~Modal_Dialog();
private:
